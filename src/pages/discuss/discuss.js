          ...
          <div className="discuss__inner">
            <div className="discuss__text">
              ...
              <p className="discuss__text__item">
                ...
                вищої освіти, враховує кращі вітчизняні та світові практики.
                надсилати на електронну адресу кафедри МСТ: d_mst@nure.ua
              </p>
              <p className="discuss__text__item">
                {" "}
              ...
              <ul className="discuss__list">
                <li className="discuss__list__item">
                  <a
                    ...
                    target="_blank"
                  >
                    Освітньо-професійна програма "Технології друкованих видань"
