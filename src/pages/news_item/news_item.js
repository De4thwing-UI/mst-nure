      ...
      <div className="news__item__inner">
        <div className="container">
          ...
          <ul className="news__list">
            ...
            <li>
              <p>
                Vitae ut vitae non posuere ac. Nisi varius sagittis nulla
                iaculis leo nisl id turpis egestas.
              </p>
            </li>
          </ul>
          <div className="news__inner__text">
            <p>
              ...
              arcu. Mauris vulputate vitae sit placerat magna. Purus elit
              praesent at diam amet lacus vel morbi non. Tortor neque tellus
              eget maecenas sodales vehicula.
            </p>
          </div>
        </div>
      </div>
