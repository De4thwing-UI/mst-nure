...
import Atestat from "../../components/atestat/atsestat"
          ...
          <div className="competition__inner">
            <div className="competition__title">
              ...
              <p className="competition__text">
                ...
                цьому році дійсні сертифікати за 2018-2021 роки. Нагадуємо, що у
                2021 році в переліку навчальних предметів, із яких проходитиме
                ЗНО, виокремлюють українську мову й українську мову і
                літературу. А математика має два рівня – стандарт та профільний.
                Для технічного ЗВО необхідно здавати ЗНО з математики
                профільного рівня
              </p>
            </div>
            <StaticImage
              ...
              <ul className="storage__list">
                <li className="storage__list__item">
                  <span className="storage__list__item__text">
                    Бал атестата про повну загальну середню освіту (коефіцієнт
                    0,1);
                  </span>
                </li>
                <li className="storage__list__item">
          ...
          <div className="olimpics__inner">
            ...
            <div className="olimpics__title">
              ...
              <p className="olimpics__text">
                ...
                та поліграфія, яка проводиться у ХНУРЕ відповідно до Положення
                (Додаток 6 до Правил вступу), можуть нараховуватись додаткові
                бали до оцінки сертифіката зовнішнього незалежного оцінювання з
                одного відповідного предмета в обсязі від 1 до 20 балів.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="coefficient__inner">
            <div className="coefficient__rating">
              ...
              <p className="rating__text">
                ...
                галузевий (ГК), сільський (СК) та першочерговий (ПЧК)
                коефіцієнти шляхом його множення на їх добуток.
