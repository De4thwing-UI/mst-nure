          ...
          <div className="student-life__inner">
            <div className="student-life__title">
              ...
              <p className="student-life__text">
                ...
                тренінги і майстер-класи, на яких студенти можуть показати себе
                і свої таланти, дізнатися щось нове.
              </p>
              <p className="student-life__text">
          ...
          <div className="molod-life__inner">
            <div className="molod-life__title">
              ...
              <p className="molod-life__text">
                ...
                «Радіоелектроніка та молодь у XXI столітті». Форум проводиться
                за підтримки Міністерства освіти і науки України з 1997 року.
              </p>
              <p className="molod-life__text">
                Мета форуму - об'єднання молодих учених, студентів та аспірантів
                різних країн навколо ідеї створення інформаційного простору,
                зміцнення між ними зв'язків, довіри і співробітництва.
              </p>
            </div>
        ...
        <div className="container">
          <div className="exhibition__inner">
            ...
            <p className="exhibition__text">
              На виставці традиційно представлені прилади, пристрої і
              програмно-апаратні розробки, розробки з програмного забезпечення,
              а також поліграфічні розробки студентів кафедри МСТ: плакати
              соціальної та екологічної тематики, журнальні та книжкові видання,
              виготовлені із застосуванням мультимедійних інформаційних
              технологій.
            </p>
          </div>
        </div>
